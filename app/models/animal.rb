class Animal < ActiveRecord::Base
  ...
  has_attached_file :fourth_image, :storage => :s3, :s3_protocol => "https", :s3_credentials => {:access_key_id => ENV['S3_KEY']  || 'thedefaultkey', :secret_access_key => ENV['S3_SECRET']  || 'thedefaultkey'}, :bucket => 'hospitium-test', :styles => { :large => "530x530", :medium => "260x180#", :thumb => "140x140>" }

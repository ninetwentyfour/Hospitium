class Animal < ActiveRecord::Base
  ...
  has_paper_trail
  has_attached_file :image, :storage => :s3, :s3_protocol => "https", :s3_credentials => {:access_key_id => "AKIAJCZTCSIU55PGYHSA"  || 'thedefaultkey', :secret_access_key => "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"  || 'thedefaultkey'}, :bucket => 'hospitium-test', :styles => { :large => "530x530>", :medium => "260x180#", :thumb => "140x140>" }
  has_attached_file :second_image, :storage => :s3, :s3_protocol => "https", :s3_credentials => {:access_key_id => "AKIAJCZTCSIU55PGYHSA"  || 'thedefaultkey', :secret_access_key => "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"  || 'thedefaultkey'}, :bucket => 'hospitium-test', :styles => { :large => "530x530>", :medium => "260x180#", :thumb => "140x140>" }
  ...
  has_attached_file :fourth_image, :storage => :s3, :s3_protocol => "https", :s3_credentials => {:access_key_id => "AKIAJCZTCSIU55PGYHSA"  || 'thedefaultkey', :secret_access_key => "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"  || 'thedefaultkey'}, :bucket => 'hospitium-test', :styles => { :large => "530x530>", :medium => "260x180#", :thumb => "140x140>" }
  #has_attached_file :fourth_image, :storage => :s3, :s3_protocol => "https", :s3_credentials => {:access_key_id => ENV['S3_KEY']  || 'thedefaultkey', :secret_access_key => ENV['S3_SECRET']  || 'thedefaultkey'}, :bucket => 'hospitium-static', :styles => { :large => "900x900>", :medium => "300x300>", :thumb => "140x140>" }

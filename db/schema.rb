...
ActiveRecord::Schema.define(:version => 20120624204951) do
  ...
  add_index "adopt_a_pet_accounts", ["organization_id"], :name => "index_adopt_a_pet_accounts_on_organization_id"
  add_index "adopt_a_pet_accounts", ["user_id"], :name => "index_adopt_a_pet_accounts_on_user_id"
  ...
  add_index "animal_weights", ["animal_id"], :name => "index_animal_weights_on_animal_id"
  ...
  add_index "twitter_accounts", ["organization_id"], :name => "index_twitter_accounts_on_organization_id"
  ...
  add_index "wordpress_accounts", ["organization_id"], :name => "index_wordpress_accounts_on_organization_id"

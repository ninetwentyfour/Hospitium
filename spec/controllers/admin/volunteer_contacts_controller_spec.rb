...
describe Admin::VolunteerContactsController do
  ...
  describe 'GET show' do
    it 'assigns the requested volunteer_contact as @volunteer_contact' do
      get :show, params: { id: @volunteer_contact.to_param }
  ...
  describe 'GET edit' do
    it 'assigns the requested volunteer_contact as @volunteer_contact' do
      get :edit, params: { id: @volunteer_contact.to_param }
      assigns(:volunteer_contact).should eq(@volunteer_contact)
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new volunteer_contact' do
        expect do
          post :create, params: { volunteer_contact: FactoryGirl.attributes_for(:volunteer_contact) }
        end.to change(VolunteerContact, :count).by(1)
      end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      it 'assigns the requested volunteer_contact as @volunteer_contact' do
        put :update, params: { id: @volunteer_contact, volunteer_contact: FactoryGirl.attributes_for(:volunteer_contact) }
        assigns(:volunteer_contact).should eq(@volunteer_contact)
      end

      it 'changes @volunteer_contact attributes' do
        put :update, params: { id: @volunteer_contact.to_param, volunteer_contact: { 'first_name' => 'Edit' } }
  ...
  describe 'DELETE destroy' do
    it 'destroys the requested volunteer_contact' do
      expect do
        delete :destroy, params: { id: @volunteer_contact.to_param }
      end.to change(VolunteerContact, :count).by(-1)
    end

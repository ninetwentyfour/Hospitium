...
describe Admin::AdoptionContactsController do
  ...
  describe 'GET show' do
    it 'assigns the requested adoption_contact as @adoption_contact' do
      get :show, params: { id: @adoption_contact.to_param }
  ...
  describe 'GET edit' do
    it 'assigns the requested adoption_contact as @adoption_contact' do
      get :edit, params: { id: @adoption_contact.to_param }
      assigns(:adoption_contact).should eq(@adoption_contact)
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new adoption_contact' do
        expect do
          post :create, params: { adoption_contact: FactoryGirl.attributes_for(:adoption_contact) }
        end.to change(AdoptionContact, :count).by(1)
      end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      it 'assigns the requested adoption_contact as @adoption_contact' do
        put :update, params: { id: @adoption_contact, adoption_contact: FactoryGirl.attributes_for(:adoption_contact) }
        assigns(:adoption_contact).should eq(@adoption_contact)
      end

      it 'changes @adoption_contact attributes' do
        put :update, params: { id: @adoption_contact.to_param, adoption_contact: { 'first_name' => 'Edit' } }
  ...
  describe 'DELETE destroy' do
    it 'destroys the requested adoption_contact' do
      expect do
        delete :destroy, params: { id: @adoption_contact.to_param }
      end.to change(AdoptionContact, :count).by(-1)
    end

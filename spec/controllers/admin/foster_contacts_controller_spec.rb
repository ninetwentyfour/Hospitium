...
describe Admin::FosterContactsController do
  ...
  describe 'GET show' do
    it 'assigns the requested foster_contact as @foster_contact' do
      get :show, params: { id: @foster_contact.to_param }
  ...
  describe 'GET edit' do
    it 'assigns the requested foster_contact as @foster_contact' do
      get :edit, params: { id: @foster_contact.to_param }
      assigns(:foster_contact).should eq(@foster_contact)
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new foster_contact' do
        expect do
          post :create, params: { foster_contact: FactoryGirl.attributes_for(:foster_contact) }
        end.to change(FosterContact, :count).by(1)
      end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      it 'assigns the requested foster_contact as @foster_contact' do
        put :update, params: { id: @foster_contact, foster_contact: FactoryGirl.attributes_for(:foster_contact) }
        assigns(:foster_contact).should eq(@foster_contact)
      end

      it 'changes @foster_contact attributes' do
        put :update, params: { id: @foster_contact.to_param, foster_contact: { 'first_name' => 'Edit' } }
  ...
  describe 'DELETE destroy' do
    it 'destroys the requested foster_contact' do
      expect do
        delete :destroy, params: { id: @foster_contact.to_param }
      end.to change(FosterContact, :count).by(-1)
    end

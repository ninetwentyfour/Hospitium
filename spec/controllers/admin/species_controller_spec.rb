...
describe Admin::SpeciesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new species" do
        expect {
          post :create, {:species => FactoryGirl.attributes_for(:species)}
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "assigns the requested species as @species" do
        put :update, id: @species, species: FactoryGirl.attributes_for(:species)
        assigns(:species).should eq(@species) 
      end
      
      it "changes @species attributes" do
        put :update, {:id => @species.to_param, :species => { "name" => "Edit" }}
        @species.reload

...
describe Admin::VetContactsController do
  ...
  describe 'GET show' do
    it 'assigns the requested vet_contact as @vet_contact' do
      get :show, params: { id: @vet_contact.to_param }
  ...
  describe 'GET edit' do
    it 'assigns the requested vet_contact as @vet_contact' do
      get :edit, params: { id: @vet_contact.to_param }
      assigns(:vet_contact).should eq(@vet_contact)
    end
  end
  ...
  describe 'POST create' do
    describe 'with valid params' do
      it 'creates a new vet_contact' do
        expect do
          post :create, params: { vet_contact: FactoryGirl.attributes_for(:vet_contact) }
        end.to change(VetContact, :count).by(1)
      end
  ...
  describe 'PUT update' do
    describe 'with valid params' do
      it 'assigns the requested vet_contact as @vet_contact' do
        put :update, params: { id: @vet_contact, vet_contact: FactoryGirl.attributes_for(:vet_contact) }
        assigns(:vet_contact).should eq(@vet_contact)
      end

      it 'changes @vet_contact attributes' do
        put :update, params: { id: @vet_contact.to_param, vet_contact: { 'clinic_name' => 'Edit' } }
        @vet_contact.reload
  ...
  describe 'DELETE destroy' do
    it 'destroys the requested vet_contact' do
      expect do
        delete :destroy, params: { id: @vet_contact.to_param }
      end.to change(VetContact, :count).by(-1)
    end
